...
I forked [the repository](https://github.com/barryclark/jekyll-now), renamed it, and then dropped my old blog posts into the _posts directory. And everything just worked. I few items in the _config.yml file to link this blog up to some of my other social accounts, ie. twitter and stackoverflow. I also enabled the rss feed and confirmed it's working with ifttt. Lots of stuff just worked with minimal work.

I also set up a new disqus site and connected it to the blog. You should be able to see comments at the end of this post. There seems to be some support for getting statistics with google analytics, which I will try to set up later. Blogging isn't about getting comments and user hits, but it does feel good when those come along. So, I'll be working on that next.
